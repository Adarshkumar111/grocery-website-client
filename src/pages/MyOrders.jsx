  ...
  return (
    <div className="mt-16 pb-16">
      ...
      {myOrders.map((order, index) => (
        ...
        >
          <p className="flex justify-between md:items text-gray-400 md:font-medium max-md:flex-col">
            ...
            >
              <div className="flex items-center mb-4 md:mb-0">
                <div className="bg-[#4fbf8b]/10 p-4 rounded-lg">
                  <img src={item.product.image[0]} alt="" className="w-20 h-20 object-contain rounded" />
                </div>
                <div className="ml-4">
