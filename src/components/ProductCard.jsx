  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-200 rounded-md p-3 md:p-4 bg-white w-full"
      >
        {/* Image */}
          ...
          <div className="flex items-end justify-between mt-3">
            ...
            >
              {!cartItems[product._id] ? (
                <button
                  className="flex items-center justify-center gap-1 bg-[#4fbf8b]/10 border border-[#4fbf8b]/40 md:w-[80px] w-[64px] h-[34px] rounded"
